import{s as e}from"./chunk-Bj-mKKzh.js";import{$ as t,Cr as n,Dr as r,Sr as i,Tr as a,dr as o,et as s,ft as c,mr as l,pr as u,xr as d}from"./src-C-vEhZB3.js";import{Q as ee,Xs as f,za as p}from"./app-server-manager-signals-Bpaj8VHp.js";import{C as m,L as te,T as ne,Z as re,_ as h,l as ie,u as g,wt as _}from"./setting-storage-dfCo8V4m.js";import{o as ae}from"./statsig--EYRNU53.js";import{t as oe}from"./invalidate-queries-and-broadcast-BXgBlyBv.js";import{u as se}from"./thread-context-inputs-Dq1kERW_.js";import{t as ce}from"./use-codex-home-CQ7goDGl.js";import{i as le,n as ue,r as de,t as fe}from"./use-is-plugins-enabled-DbPtU22F.js";function pe(){return window.electronBridge?.getBuildFlavor?.()||`prod`}var v=[`<svg
...
`].map(e=>`data:image/svg+xml,${encodeURIComponent(e)}`);function y(e){let t=0;for(let n=0;n<e.length;n+=1)t=(t*31+e.charCodeAt(n))%v.length;return v[t]??``}var b=e(r(),1),x={".svg":`image/svg+xml`,".png":`image/png`,".jpg":`image/jpeg`,".jpeg":`image/jpeg`,".webp":`image/webp`,".gif":`image/gif`,".avif":`image/avif`};async function S(e,t,n){let r=C(e);if(r==null)return null;try{let e={path:r,hostId:t},i=await n.fetchQuery({queryFn:({signal:t})=>ie(`read-file-binary`,{params:e,signal:t}),queryKey:g(`read-file-binary`,e),retry:!1,gcTime:1/0,staleTime:h.INFINITE});return i.contentsBase64?`data:${w(r)};base64,${i.contentsBase64}`:null}catch(e){return m.warning(`Failed to inline local image`,{safe:{},sensitive:{error:e,resolvedImagePath:r}}),null}}function C(e){if(e==null)return null;let t=e.trim();if(t.length===0)return null;let n=t.toLowerCase();if(n.startsWith(`data:`)||n.startsWith(`http:`)||n.startsWith(`https:`)||n.startsWith(`file:`)||n.startsWith(`vscode-resource:`)||n.startsWith(`vscode-webview:`)||n.startsWith(`vscode-file:`))return null;let r=a(t);return d(r)?r:null}function w(e){return x[b.default.extname(e).toLowerCase()]??`application/octet-stream`}var me=_(),T=[`plugins`],E=4,D=[],he=[],O=[],ge=[],k=[],A=`computer-use`,j=`.tmp/marketplaces/openai-internal-testing`,M=new Set([`codex-official`,o,t,s,`openai-primary-runtime`].map(Y));function N(e){return{...je(e.summary),description:e.summary.interface?.shortDescription??e.description??null,displayName:e.summary.interface?.displayName??null,marketplaceDisplayName:null,marketplaceName:e.marketplaceName,plugin:e.summary,keywords:e.summary.keywords,...B({marketplaceName:e.marketplaceName,marketplacePath:e.marketplacePath})}}function P({marketplacePath:e,remoteMarketplaceName:t}){if(e!=null&&t!=null)throw Error(`plugin marketplace request requires one marketplace source`);if(e!=null)return{marketplacePath:e};if(t!=null)return{remoteMarketplaceName:t};throw Error(`plugin marketplace request requires a marketplace source`)}function F(e){return e.marketplacePath??`remote:${e.remoteMarketplaceName}`}function I(e){return e.marketplacePath==null?R(e.plugin):e.plugin.name}function L(e){return e.marketplacePath==null?R(e.plugin):e.plugin.id}function R(e){if(e.remotePluginId==null)throw Error(`remote plugin ${e.id} is missing remotePluginId`);return e.remotePluginId}function z(e){return{...P(e),pluginName:I(e)}}function B({marketplaceName:e,marketplacePath:t}){return t==null?{marketplacePath:null,remoteMarketplaceName:e}:{marketplacePath:t,remoteMarketplaceName:null}}function V(e,n,r){let i=(0,me.c)(54),a;i[0]===e?a=i[1]:(a={hostId:e},i[0]=e,i[1]=a);let o=fe(a)&&(r?.enabled??!0),s=r?.additionalMarketplaceKinds??O,c=r?.installSuggestionPluginNames??null,l=ae(`4218407052`),u=be({additionalMarketplaceKinds:s,includeRemoteCatalog:r?.includeRemoteCatalog??!0,includeVerticalCatalog:!l}),d=oe(),p=te(),m=re(se),ie=ce(e),g=re(ee),_;i[2]!==e||i[3]!==g?(_=g.includes(e),i[2]=e,i[3]=g,i[4]=_):_=i[4];let v=_,y=o&&v,b;i[5]!==e||i[6]!==y?(b={enabled:y,hostId:e},i[5]=e,i[6]=y,i[7]=b):b=i[7];let x=le(b),S;i[8]===e?S=i[9]:(S={hostId:e},i[8]=e,i[9]=S);let C=ue(S),w;i[10]===e?w=i[11]:(w={hostId:e},i[10]=e,i[11]=w);let E=de(w),A=n===void 0,j=Ae({codexHome:ie,hostId:e,rootsOverrideCwd:n,workspaceRoots:m.data?.roots}),M=o&&v&&(n!==void 0||m.isFetched),N;i[12]===Symbol.for(`react.memo_cache_sentinel`)?(N=pe(),i[12]=N):N=i[12];let P=N,F=c==null?xe(e,j,u,l):ye(e,j,O,c,l),I;i[13]!==P||i[14]!==e||i[15]!==c||i[16]!==l||i[17]!==u||i[18]!==p||i[19]!==j?(I=async()=>{let n=l?t:null;if(c!=null){let t=await f(`send-cli-request-for-host`,{hostId:e,method:`plugin/installed`,params:{...j.length>0?{cwds:j}:{},installSuggestionPluginNames:c}}),r=Se(t.marketplaces,n),i=$(r);return{featuredPluginIds:D,marketplaceLoadErrors:t.marketplaceLoadErrors,marketplaces:Oe(r),plugins:await ke({hostId:e,plugins:i,queryClient:p})}}let r=await f(`list-plugins`,u==null?{hostId:e,...j.length>0?{cwds:j}:{}}:{hostId:e,...j.length>0?{cwds:j}:{},marketplaceKinds:u}),i=Se(r.marketplaces,n),a=$(i),o=P==null?a:De({buildFlavor:P,plugins:a}),s=n==null?r.featuredPluginIds:r.featuredPluginIds.filter(e=>!e.endsWith(`@${n}`));return{featuredPluginIds:P==null?s:Ee({buildFlavor:P,featuredPluginIds:s}),marketplaceLoadErrors:r.marketplaceLoadErrors,marketplaces:Oe(i),plugins:await ke({hostId:e,plugins:o,queryClient:p})}},i[13]=P,i[14]=e,i[15]=c,i[16]=l,i[17]=u,i[18]=p,i[19]=j,i[20]=I):I=i[20];let L;i[21]!==M||i[22]!==F||i[23]!==I?(L={queryKey:F,queryFn:I,enabled:M,staleTime:h.FIVE_MINUTES,gcTime:1/0},i[21]=M,i[22]=F,i[23]=I,i[24]=L):L=i[24];let R=ne(L),z;i[25]!==d||i[26]!==R?(z=async function(){await d(T),await R.refetch()},i[25]=d,i[26]=R,i[27]=z):z=i[27];let B=z;if(!o||!v){let e;return i[28]===Symbol.for(`react.memo_cache_sentinel`)?(e={availablePlugins:k,featuredPluginIds:D,installedPlugins:k,marketplaceLoadErrors:he,marketplaces:ge,errorMessage:null,isLoading:!1,isFetching:!1,refetch:ve,forceReload:_e},i[28]=e):e=i[28],e}let V,H,U,W;i[29]!==x.available||i[30]!==E.available||i[31]!==C.available||i[32]!==R.data?.featuredPluginIds||i[33]!==R.data?.plugins?(V={isComputerUseAvailable:x.available,isExternalBrowserUseAvailable:E.available,isInAppBrowserUseAvailable:C.available},H=R.data?.plugins??k,U=we({plugins:H,...V}),W=Ce({featuredPluginIds:R.data?.featuredPluginIds??D,...V}),i[29]=x.available,i[30]=E.available,i[31]=C.available,i[32]=R.data?.featuredPluginIds,i[33]=R.data?.plugins,i[34]=V,i[35]=H,i[36]=U,i[37]=W):(V=i[34],H=i[35],U=i[36],W=i[37]);let G;i[38]===H?G=i[39]:(G=Te(H),i[38]=H,i[39]=G);let K=R.data?.marketplaceLoadErrors??he,q=R.data?.marketplaces??ge,J=R.error?String(R.error.message):null,Y=A&&m.isLoading||R.isLoading||C.isLoading||E.isLoading||x.isLoading,X=A&&m.isFetching||R.isFetching||x.isFetching,Z;i[40]!==V||i[41]!==R?(Z=async()=>{let e=(await R.refetch()).data?.plugins??k;return{availablePlugins:we({plugins:e,...V}),installedPlugins:Te(e)}},i[40]=V,i[41]=R,i[42]=Z):Z=i[42];let Q;return i[43]!==B||i[44]!==U||i[45]!==W||i[46]!==G||i[47]!==K||i[48]!==q||i[49]!==J||i[50]!==Y||i[51]!==X||i[52]!==Z?(Q={availablePlugins:U,featuredPluginIds:W,installedPlugins:G,marketplaceLoadErrors:K,marketplaces:q,errorMessage:J,isLoading:Y,isFetching:X,refetch:Z,forceReload:B},i[43]=B,i[44]=U,i[45]=W,i[46]=G,i[47]=K,i[48]=q,i[49]=J,i[50]=Y,i[51]=X,i[52]=Z,i[53]=Q):Q=i[53],Q}async function _e(){}async function ve(){return{availablePlugins:k,installedPlugins:k}}function H(e){let t=(0,me.c)(10),{enabled:n,hostId:r,marketplaceKind:i}=e,a=n===void 0?!0:n,o;t[0]===r?o=t[1]:(o={hostId:r},t[0]=r,t[1]=o);let s=fe(o),c,l;t[2]!==r||t[3]!==i?(c=[...T,`marketplace-kind`,r,i],l=async()=>$((await f(`list-plugins`,{hostId:r,marketplaceKinds:[i]})).marketplaces),t[2]=r,t[3]=i,t[4]=c,t[5]=l):(c=t[4],l=t[5]);let u=a&&s,d;return t[6]!==c||t[7]!==l||t[8]!==u?(d={queryKey:c,queryFn:l,enabled:u,staleTime:h.FIVE_MINUTES},t[6]=c,t[7]=l,t[8]=u,t[9]=d):d=t[9],ne(d)}function ye(e,t,n=O,r=null,i=!1){return r==null?xe(e,t,be({additionalMarketplaceKinds:n,includeRemoteCatalog:!0,includeVerticalCatalog:!i}),i):[...T,e,t,`installed`,r,`curated-marketplace`,U(i)]}function be({additionalMarketplaceKinds:e,includeRemoteCatalog:t,includeVerticalCatalog:n}){return t&&!n&&e.length===0?null:n?[`local`,`vertical`,...e]:[`local`,...e]}function xe(e,t,n,r){let i=U(r);return n==null?[...T,e,t,`curated-marketplace`,i]:[...T,e,t,`marketplace-kinds`,n,`curated-marketplace`,i]}function U(e){return e?s:t}function Se(e,t){return t==null?e:e.filter(e=>e.name!==t)}function Ce({featuredPluginIds:e,...t}){return e.filter(e=>W(e,t))}function we({plugins:e,...t}){return e.filter(e=>W(e.plugin.id,t))}function Te(e){return e.filter(e=>e.plugin.installed)}function W(e,{isComputerUseAvailable:t,isExternalBrowserUseAvailable:n,isInAppBrowserUseAvailable:r}){return!(!r&&G(e)||!n&&K(e)||!t&&q(e))}function G(e){let t=J(e);return t===`browser`||t===`browser-use`}function K(e){let t=J(e);return t===`chrome`||t===`chrome-dev`||t===`chrome-internal`}function q(e){return J(e)===A}function J(e){return e.split(`@`)[0]}function Ee({buildFlavor:e,featuredPluginIds:t}){let n=u(e);return t.filter(e=>{let t=c(e);return t==null?!0:!l(t)||t===n})}function De({buildFlavor:e,plugins:t}){let n=u(e);return t.filter(e=>!l(e.marketplaceName)||e.marketplaceName===n)}function Y(e){return e.trim().toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)}function X(e){return M.has(Y(e))}function Oe(e){let t=new Map;for(let n of e){let e=`${n.name}\u0000${n.path??``}`;if(t.has(e))continue;let r=X(n.name);t.set(e,{displayName:n.interface?.displayName??null,isBuiltIn:r,name:n.name,path:n.path,pluginCount:n.plugins.length})}return Array.from(t.values()).sort((e,t)=>{let n=e.displayName?.trim()||e.name,r=t.displayName?.trim()||t.name;return n.localeCompare(r)})}async function ke({hostId:e,plugins:t,queryClient:n}){let r=[...t];async function i(a){let o=t[a];if(o==null)return;let[s,c]=await Promise.all([S(o.composerIconPath,e,n),S(o.logoPath,e,n)]);(s!=null||c!=null)&&(r[a]={...o,composerIconPath:s??o.composerIconPath,logoPath:c??o.logoPath,plugin:o.plugin.interface?{...o.plugin,interface:{...o.plugin.interface,...s==null?{}:{composerIcon:s},...c==null?{}:{logo:c}}}:o.plugin}),await i(a+E)}return await Promise.all(Array.from({length:Math.min(E,t.length)},(e,t)=>i(t))),r}function Ae({codexHome:e,hostId:t,rootsOverrideCwd:n,workspaceRoots:r}){let i=t===`local`&&e!=null?p(e,j):null;return Z([...typeof n==`string`?[n]:n??r??[],...i==null?[]:[i]],e)}function Z(e,t){return Array.from(new Set(e.map(e=>e.trim()).filter(e=>d(e)&&Q(e,t))))}function Q(e,t){return t==null?!0:i(t)||n(t)?i(e)||n(e):e.startsWith(`/`)&&!e.startsWith(`//`)}function $(e){let t=new Map;for(let n of e)for(let e of n.plugins)t.has(e.id)||t.set(e.id,{...je(e),description:e.interface?.shortDescription??null,displayName:e.interface?.displayName??null,marketplaceDisplayName:n.interface?.displayName??null,marketplaceName:n.name,plugin:e,keywords:e.keywords,...B({marketplaceName:n.name,marketplacePath:n.path})});return Array.from(t.values())}function je(e){let t=e.interface?.composerIcon??e.interface?.composerIconUrl??null,n=e.interface?.logo??e.interface?.logoUrl??null;if(t!=null||n!=null)return{composerIconPath:t,logoPath:n};let r=y(e.id);return{composerIconPath:r,logoPath:r}}export{S as _,P as a,L as c,q as d,K as f,C as g,H as h,F as i,R as l,V as m,N as n,z as o,G as p,je as r,I as s,T as t,X as u,pe as v};
//# sourceMappingURL=use-plugins-054I4ymj.js.map